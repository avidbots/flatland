...
public:
  ...
  /// modified by calling SetAutoClearForces. The purpose of this function is to
  /// support sub-stepping. Sub-stepping is often used to maintain a fixed sized
  /// time step under a variable frame-rate. When you perform sub-stepping you
  /// will disable auto clearing of forces and instead call ClearForces after
  /// all sub-steps are complete in one pass of your game loop.
  /// @see SetAutoClearForces
  void ClearForces();

  /// Call this to draw shapes and other debug draw data. This is intentionally
  /// non-const.
  void DrawDebugData();
  ...
  /// Get the world body list. With the returned body, use b2Body::GetNext to
  /// get the next body in the world list. A nullptr body indicates the end of
  /// the list.
  /// @return the head of the world body list.
  b2Body * GetBodyList();
  const b2Body * GetBodyList() const;

  /// Get the world joint list. With the returned joint, use b2Joint::GetNext to
  /// get the next joint in the world list. A nullptr joint indicates the end of
  /// the list.
  ...
  /// b2Contact::GetNext to get the next contact in the world list. A nullptr
